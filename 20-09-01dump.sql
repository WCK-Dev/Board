...
CREATE TABLE `board` (
  ...
  `b_commentCnt` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`b_no`)
...
INSERT INTO `comment` VALUES (1,'wck','3333','2020-09-01 09:08:02',14),(2,'wck','테스트 댓글 작성입니다 111','2020-09-01 09:47:22',14),(3,'wck','131314555','2020-09-01 09:47:43',14),(4,'wck','131314555','2020-09-01 09:48:04',14),(5,'wck','412512413215','2020-09-01 09:48:22',14),(6,'wck','123123','2020-09-01 09:49:08',14),(7,'wck','3535','2020-09-01 09:49:16',14);
...
INSERT INTO `user` VALUES ('admin','1234','관리자','Y','Y','Y','Y','Y','Y','Y'),('fusion','fusion1234','우치경','Y','Y','Y','Y','Y','Y','Y'),('fusion1','fusion1234','우치경','Y','Y','Y','Y','N','Y','N'),('fusion1234','fusion1234','우치경','Y','Y','Y','Y','Y','Y','Y'),('ktw1989','xodn1989','김태우','Y','N','N','N','N','N','N'),('user','1234','이용자','Y','Y','Y','Y','Y','Y','Y'),('wck','1234','우치경','Y','N','N','N','N','Y','N'),('wck1234','wck1234','우치경','Y','N','N','N','N','N','N'),('yhsyhs','asd123','현수임','Y','N','N','N','N','N','N');
...
-- Dump completed on 2020-09-01 18:53:10
